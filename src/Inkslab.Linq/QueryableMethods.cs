...
#pragma warning restore IDE0130 // 命名空间与文件夹结构不匹配
{
    ...
    {
        /// <summary>
        ///     The <see cref="MethodInfo" /> for <see cref="Queryable.AsQueryable(IEnumerable)" />
        /// </summary>
        public static MethodInfo AsQueryable { get; }

        /// <summary>
        ///     The <see cref="MethodInfo" /> for <see cref="Queryable.Cast{TResult}(IQueryable)" />
        /// </summary>
        public static MethodInfo Cast { get; }

        /// <summary>
        ///     The <see cref="MethodInfo" /> for <see cref="Queryable.OfType{TResult}(IQueryable)" />
        /// </summary>
        ...
        /// <summary>
        ///     The <see cref="MethodInfo" /> for <see cref="Queryable.Concat{TSource}(IQueryable{TSource},IEnumerable{TSource})" />
        /// </summary>
        ...
        /// <summary>
        ///     The <see cref="MethodInfo" /> for <see cref="Queryable.Reverse{TSource}(IQueryable{TSource})" />
        /// </summary>
        ...
        /// <summary>
        ///     The <see cref="MethodInfo" /> for <see cref="Queryable.Skip{TSource}(IQueryable{TSource},int)" />
        /// </summary>
        ...
        /// <summary>
        ///     The <see cref="MethodInfo" /> for <see cref="Queryable.DefaultIfEmpty{TSource}(IQueryable{TSource},TSource)" />, not supported yet!
        /// </summary>
        ...
        /// </summary>
        public static MethodInfo DataSharding { get; }
        ...
        ///     The <see cref="QueryableExtentions" /> for
        ///     <see
        ///         cref="QueryableExtentions.NoElementError{TSource}(IQueryable{TSource}, string)" />
        /// </summary>
        public static MethodInfo NoElementError { get; }
        /// <summary>
        ///     The <see cref="QueryableExtentions" /> for
        ///     <see
        ///         cref="QueryableExtentions.Update{T}(IQueryable{T}, Expression{Func{T, T}})" />
        /// </summary>
        public static MethodInfo Update { get; }
        /// <summary>
        ///     The <see cref="QueryableExtentions" /> for
        ///     <see
        ///         cref="QueryableExtentions.Delete{T}(IQueryable{T})" />
        /// </summary>
        public static MethodInfo Delete { get; }
        /// <summary>
        ///     The <see cref="QueryableExtentions" /> for
        ///     <see
        ///         cref="QueryableExtentions.Delete{T}(IQueryable{T},Expression{Func{T, bool}})" />
        /// </summary>
        ...
        ///     The <see cref="QueryableExtentions" /> for
        ///     <see
        ///         cref="QueryableExtentions.Insert{T}(IQueryable{T}, IQueryable{T})" />
        /// </summary>
        ...
        static QueryableMethods()
        {
            ...
            ElementAt = queryableMethods.Single(mi =>
            {
                if (mi.Name == nameof(Queryable.ElementAt))
                {
                    var parameterInfos = mi.GetParameters();

                    return parameterInfos.Length == 2 && parameterInfos[1].ParameterType == intType;
                }

                return false;
            });

            ElementAtOrDefault = queryableMethods.Single(mi =>
            {
                if (mi.Name == nameof(Queryable.ElementAtOrDefault))
                {
                    var parameterInfos = mi.GetParameters();
            ...
            Take = queryableMethods.Single(mi =>
            {
                if (mi.Name == nameof(Queryable.Take))
                {
                    var parameterInfos = mi.GetParameters();
            ...
            var repositoryMethods = typeof(QueryableExtentions)
            ...
            Insert = repositoryMethods.Single(mi => mi.Name == nameof(QueryableExtentions.Insert));
            Update = repositoryMethods.Single(mi => mi.Name == nameof(QueryableExtentions.Update));
            Delete = repositoryMethods.Single(mi => mi.Name == nameof(QueryableExtentions.Delete) && mi.GetParameters().Length == 1);
            DeleteWithPredicate = repositoryMethods.Single(mi => mi.Name == nameof(QueryableExtentions.Delete) && mi.GetParameters().Length == 2);
        }
    }
}
